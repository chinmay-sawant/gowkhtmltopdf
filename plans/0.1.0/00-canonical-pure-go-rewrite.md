...
> **Post-MVP work:** active ledger → [`10-canonical-post-mvp-roadmap.md`](../0.2.0/10-canonical-post-mvp-roadmap.md) (phases 10–23; quick-win order). Do not reopen completed MVP rows here for quality work - record there.
