...
| [memory-profiling-2026-09-10.md](memory-profiling-2026-09-10.md) | Golden-corpus heap/stack profiling plus generation benchmarks (2026-09-10, opt-in harness in `internal/profiling/`, 65 templates, PDF + PNG + JPEG). All 13 `IMPROV-*` rows implemented and measured: PDF B/op -52% / allocs -94.5%, PNG -41% / -93.4%, JPEG -43% / -99.5%. Profiles live in gitignored `output/profiles/` |
