...
> **Status:** complete (2026-08-07) — all 7 rows closed and validated; see `fix-log/` and the closure gates in Phase 6
...
- [x] **P5-01** — done — StyleOf/FakeBoldFor/PaintBand; convert HF + imageout FakeBoldFor
- [x] **P5-02** — done — CollectSheets/MergeFontFaces shared; multi-page PDF assembly stays convert-specific
- [x] **P5-03** — done (fix-pdf-fonts)
- [x] **P5-04** — done (fix-pdf-fonts)
- [x] **P5-05** — done — Font-local caches + per-raster glyphAtlas
- [x] **P5-06** — done (fix-pdf-fonts)
- [x] **P5-07** — done — pdf + layout paint image-embed errors
