...
- [validator-test/](0.2.7/validator-test/95-canonical-pixel-regression-tests.md) - The 65-reference inventory and corpus test are present. The pinned visual run and CI remain open. Phase 94 stays active until full migration.
