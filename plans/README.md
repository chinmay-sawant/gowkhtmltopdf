...
| [0.2.7/](0.2.7/README.md) | **v0.2.7 next-72 + next-100 CSS** - 72-property wave (fixture-64) closed; next-100 wave planned (88.1-88.9, fixture-66); output position-range tests planned (94.0-94.9) | next-72 complete on `feature/027-next-72`; next-100 planned; position suite not started |
...
- [validator-test/](0.2.7/validator-test/94-canonical-output-position-tests.md) - Output PDF position ranges for the 65 fixture samples plus the 8 version and compliance copies (phases 94.0-94.9, not started)
