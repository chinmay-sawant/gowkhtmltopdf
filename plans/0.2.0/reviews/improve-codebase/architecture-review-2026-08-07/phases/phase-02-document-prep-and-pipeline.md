...
> **Status:** complete (2026-08-07) — all 14 rows closed and validated; see `fix-log/` and the closure gates in Phase 6
...
- [x] **P2-01** — done — convert.CollectSheets; imageout deleted twin
- [x] **P2-02** — done — DocPage once; consumers use DocPage view
- [x] **P2-03** — done — pagePlan OwnerOf/Remap/Ranges
- [x] **P2-04** — done — SetBody/AddHTML/ConvertHTML + image SetBody + load InlineHTML
- [x] **P2-05** — done — SortHeadings/SectionOf + convert consumers
- [x] **P2-06** — done — hfGeom.pdfY/pdfXY/pdfRect; locationOf deleted
- [x] **P2-07** — done — NewLoader applies ACL; convert/imageout pokes removed
- [x] **P2-08** — done — Walk/TextContentOf + convert/imageout/outline
- [x] **P2-09** — done — ParseDocument + load charset seam; --default-encoding still ignored (ponytail residual)
- [x] **P2-10** — done — objectPlacement + explicit HF registry return
- [x] **P2-11** — done — newHFGeom + bodyLayoutOpts
- [x] **P2-12** — done — applyInternalLinks cmd dropped; paintCount returns error
- [x] **P2-13** — done — layout.DeactivateOp + convert consumer
- [x] **P2-14** — done — CollectSheets + MergeFontFaces shared
