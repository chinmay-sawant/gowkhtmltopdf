...
> **Status:** complete (2026-08-07) — all 6 rows closed and validated; see `fix-log/` and the closure gates in Phase 6
...
- [x] **P3-01** — done — matchedRules unifies cascadeRaw + pseudo-content
- [x] **P3-02** — done — css.ParseSelectors + convert consumer
- [x] **P3-03** — done — css.LengthToPt + layout + convert/toc
- [x] **P3-04** — done — ResolveCustomProps + layout merge
- [x] **P3-05** — done — resolveStylesWith
