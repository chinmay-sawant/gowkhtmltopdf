...
- [ ] 94.9.1 Every new `.go` file from this ledger is at or under 2000 lines. Record `wc -l` for `internal/pdf/page_ops.go`, `internal/pdf/page_ops_test.go`, `internal/convert/fixturetests/output_ops_test.go`, `internal/convert/fixturetests/output_fixture_shape_test.go`, and every `internal/convert/fixturetests/output_fixture_*_test.go` file.
...
go test ./internal/convert/fixturetests -run 'TestOutputFixture' -count=1: exit 0
make test: exit 0
make golden: exit 0
