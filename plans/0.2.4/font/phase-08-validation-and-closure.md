...
- [ ] Update this folder's status and `plans/0.2.4/README.md` only after all
  required gates pass.
- [ ] Keep the parent 0.2.4 phases 31–39 status honest; do not mark their old
  closure evidence as proof for this new track.
- [ ] Record deferred work explicitly, such as proprietary-font licensing,
  browser pixel parity, unsupported font formats, or variable-font support.
...
- [ ] Documentation accurately states exact-font versus fallback behavior.
