...
func TestCanonicalProfileAndHelpers(t *testing.T) {
	...
	tests := []struct {
		...
		{input: "", wantCanon: "", wantPDFA3: false, wantPDFUA1: false, wantCompl: false},
		{input: "   ", wantCanon: "", wantPDFA3: false, wantPDFUA1: false, wantCompl: false},
		// PDF/A-3a aliases
		{input: "PDF/A-3a", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "pdf/a-3a", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "a3a", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "pdfa-3a", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "pdf-a-3a", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "a-3a", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "pdf/a-3", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		{input: "a3", wantCanon: ProfilePDFA3a, wantPDFA3: true, wantPDFUA1: false, wantCompl: true},
		// PDF/UA-1 aliases
		{input: "PDF/UA-1", wantCanon: ProfilePDFUA1, wantPDFA3: false, wantPDFUA1: true, wantCompl: true},
		{input: "pdf/ua-1", wantCanon: ProfilePDFUA1, wantPDFA3: false, wantPDFUA1: true, wantCompl: true},
		{input: "ua1", wantCanon: ProfilePDFUA1, wantPDFA3: false, wantPDFUA1: true, wantCompl: true},
		{input: "pdfua-1", wantCanon: ProfilePDFUA1, wantPDFA3: false, wantPDFUA1: true, wantCompl: true},
		{input: "ua-1", wantCanon: ProfilePDFUA1, wantPDFA3: false, wantPDFUA1: true, wantCompl: true},
		{input: "pdf/ua", wantCanon: ProfilePDFUA1, wantPDFA3: false, wantPDFUA1: true, wantCompl: true},
		// Dual profile aliases
		{input: "PDF/A-3a+PDF/UA-1", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "pdf/a-3a+pdf/ua-1", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "a3a-ua1", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "a3a+ua1", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "pdf/a-3a-pdf/ua-1", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "pdfa-3a+pdfua-1", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "pdf/ua-1+pdf/a-3a", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "ua1+a3a", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		{input: "ua1-a3a", wantCanon: ProfilePDFA3aPDFUA1, wantPDFA3: true, wantPDFUA1: true, wantCompl: true},
		// Unsupported or unknown
		{input: "PDF/A-4", wantCanon: "", wantPDFA3: false, wantPDFUA1: false, wantCompl: false},
		{input: "PDF/UA-2", wantCanon: "", wantPDFA3: false, wantPDFUA1: false, wantCompl: false},
		{input: "PDF/A-1b", wantCanon: "", wantPDFA3: false, wantPDFUA1: false, wantCompl: false},
		{input: "custom-profile", wantCanon: "", wantPDFA3: false, wantPDFUA1: false, wantCompl: false},
	}
...
func TestProfileValidationMatrix(t *testing.T) {
	...
	tests := []struct {
		...
		// Unsupported PDF 2.0 profiles
		{
			name:    "PDF17 with PDF/A-4 returns ErrConformanceProfilesUnsupported",
			policy:  WriterPolicy{Version: PDF17, ConformanceProfile: "PDF/A-4"},
			wantErr: ErrConformanceProfilesUnsupported,
		},
		{
			name:    "PDF17 with a4 alias returns ErrConformanceProfilesUnsupported",
			policy:  WriterPolicy{Version: PDF17, ConformanceProfile: "a4"},
			wantErr: ErrConformanceProfilesUnsupported,
		},
		{
			name:    "PDF17 with PDF/UA-2 returns ErrConformanceProfilesUnsupported",
			policy:  WriterPolicy{Version: PDF17, ConformanceProfile: "PDF/UA-2"},
			wantErr: ErrConformanceProfilesUnsupported,
		},
		{
			name:    "PDF17 with ua2 alias returns ErrConformanceProfilesUnsupported",
