...
func TestAdjacentCiteMarkersSeparated(t *testing.T) { //nolint:cyclop
	t.Parallel()
...
<sup class="reference"><a href="#a"><span>[</span>90<span>]</span></a></sup>`+
		`<sup class="reference"><a href="#b"><span>[</span>91<span>]</span></a></sup>`+
		`<sup class="reference"><a href="#c"><span>[</span>92<span>]</span></a></sup>
