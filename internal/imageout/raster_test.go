...
func TestRasterOpPolicyParity(t *testing.T) {
	...
	t.Run("TextTransform", func(t *testing.T) {
		...
		img, err := rasterizeContext(t.Context(), res, 50, true, 0, 0)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("Opacity", func(t *testing.T) {
		...
		imgOpaque, err := rasterizeContext(t.Context(), resOpaque, 50, false, 0, 0)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("WritingModeVertical", func(t *testing.T) {
		...
		imgVert, err := rasterizeContext(t.Context(), resVert, 100, false, 0, 0)
		if err != nil {
			t.Fatal(err)
		}
