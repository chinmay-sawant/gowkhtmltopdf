...
rasterization), and
[`tdewolff/font`](https://github.com/tdewolff/font) (WOFF2 font decoding).
Builds are intended to run with `CGO_ENABLED=0`.

**Status:** **v0.2.6** is the current release (`VERSION`). Phases 0–9 of the
...
| **Pure Go** | Build with `CGO_ENABLED=0`; three allowlisted Go modules provide shaping, SVG raster, and WOFF2 decoding |
