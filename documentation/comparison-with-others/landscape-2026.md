...
| **PDF standards** | Opt-in PDF/A-3a+UA-1 and PDF/A-4+UA-2 via `--pdf-profile`; no forms or encryption | No PDF/A/forms/encryption in the basic PDF API; tagged PDF and outlines are experimental | No | **PDF/A-1/2/3, PDF/UA, forms**; validity still needs validation | Strong standards/commercial extras; verify the required profile |
