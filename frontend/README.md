...
stdlib-only HTML-to-PDF/PNG converter that is a clean-room work-alike of
[wkhtmltopdf](https://github.com/wkhtmltopdf/wkhtmltopdf).

The site tells two stories:

1. **What the product is**: Overview, Getting Started, CLI, Library API,
   Architecture, Compatibility, Fonts, Security, and About pages. The long-form
   content in `src/data/content/*.json` was generated by 10 subagents that
   scanned the repo's documentation markdown and Go source, so every claim is
