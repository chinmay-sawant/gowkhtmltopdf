...
export const SHOWCASE = [
  ...
  {
    name: 'fixture-63-page-level-demos',
    file: 'fixture-63-page-level-demos.pdf',
    pages: 7,
    title: 'Page-level demos',
    desc: 'Page breaks on normal flow, an inert footnote area, and a dark color-scheme canvas.',
    category: 'CSS & layout fixtures',
  },
  {
    name: 'fixture-62-implemented-props-c',
    file: 'fixture-62-implemented-props-c.pdf',
    pages: 8,
    title: 'Implemented CSS audit C',
    desc: 'Third slice of the implemented-property gallery: 120 properties, each with a description and an Effect cell.',
    category: 'CSS & layout fixtures',
  },
  {
    name: 'fixture-61-implemented-props-b',
    file: 'fixture-61-implemented-props-b.pdf',
    pages: 8,
    title: 'Implemented CSS audit B',
    desc: 'Second slice of the implemented-property gallery: 118 properties, each with a description and an Effect cell.',
    category: 'CSS & layout fixtures',
  },
  {
    name: 'fixture-60-implemented-props-a',
    file: 'fixture-60-implemented-props-a.pdf',
    pages: 8,
    title: 'Implemented CSS audit A',
    desc: 'First slice of the implemented-property gallery: 118 properties, each with a description and an Effect cell.',
    category: 'CSS & layout fixtures',
  },
  {
    name: 'fixture-59-apex-digital-landing',
    file: 'fixture-59-apex-digital-landing.pdf',
    pages: 9,
  ...
  {
    name: 'fixture-29-wpt-break-nested-float-print',
    file: 'fixture-29-wpt-break-nested-float-print.pdf',
    pages: 3,
    title: 'Nested float fragmentation',
    desc: 'Three-page flex column where a six-inch float splits across pages and the label stays in order.',
    category: 'CSS & layout fixtures',
  },
  {
