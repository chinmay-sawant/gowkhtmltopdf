...
assert.match(appSource, /path=['"]\/live-demo['"]/, 'App should register the live demo route')
assert.match(appSource, /path=['"]\/wasm['"]/, 'App should keep a /wasm redirect for old links')
assert.match(appSource, /Navigate to=['"]\/live-demo['"]/, 'App should redirect /wasm to /live-demo')
